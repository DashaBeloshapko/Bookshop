...
// import { ADD_TO_CART, INCREASE_QUANTITY, DECREASE_QUANTITY, REMOVE_FROM_FAVORITES, ADD_TO_FAVORITES, SET_BOOKS, SET_BOOKS_LIMIT, SET_CURRENT_BOOK, SET_CURRENT_PAGE, SET_SELECTED_BOOK, SET_TOTAL, REMOVE_FROM_CART } from '../actionTypes';
